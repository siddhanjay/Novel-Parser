Usage instructions : Run the python file novel_parser.py and specify the name the input novel file name .

This program is tested on many novels from the "Gutenberg Project"
